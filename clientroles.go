...
func newClientRoles(sdkConfig sdkConfiguration) *clientRoles {
	return &clientRoles{
...
func (s *clientRoles) Get(ctx context.Context) (*operations.GetClientRolesResponse, error) {
	...
	res := &operations.GetClientRolesResponse{
