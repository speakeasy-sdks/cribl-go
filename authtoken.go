...
func newAuthToken(sdkConfig sdkConfiguration) *authToken {
	return &authToken{
...
func (s *authToken) Login(ctx context.Context, request shared.LoginInfo) (*operations.LoginAuthTokenResponse, error) {
