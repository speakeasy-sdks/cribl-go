...
// Create PolicyRule
func (s *policies) Create(ctx context.Context, request shared.PolicyRule) (*operations.CreatePolicyRuleResponse, error) {
...
// Delete PolicyRule
func (s *policies) Delete(ctx context.Context, id string) (*operations.DeletePolicyRuleResponse, error) {
...
func (s *policies) Get(ctx context.Context, id string) (*operations.GetPolicyRuleResponse, error) {
...
// Update PolicyRule
func (s *policies) Update(ctx context.Context, id string, policyRule *shared.PolicyRule) (*operations.UpdatePolicyRuleResponse, error) {
