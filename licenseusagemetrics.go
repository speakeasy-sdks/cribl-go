...
func newLicenseUsageMetrics(sdkConfig sdkConfiguration) *licenseUsageMetrics {
	return &licenseUsageMetrics{
...
func (s *licenseUsageMetrics) Get(ctx context.Context) (*operations.GetLicenseUsageMetricsResponse, error) {
	...
	res := &operations.GetLicenseUsageMetricsResponse{
