...
func newCurrentConfig(sdkConfig sdkConfiguration) *currentConfig {
...
func (s *currentConfig) Push(ctx context.Context) (*operations.PushCurrentConfigResponse, error) {
