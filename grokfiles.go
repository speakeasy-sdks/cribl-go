...
// Create GrokFile
func (s *grokfiles) Create(ctx context.Context, request shared.GrokFile) (*operations.CreateGrokFileResponse, error) {
...
// Delete GrokFile
func (s *grokfiles) Delete(ctx context.Context, id string) (*operations.DeleteGrokFileResponse, error) {
...
// Get GrokFile by ID
func (s *grokfiles) Get(ctx context.Context, id string) (*operations.GetGrokFileResponse, error) {
...
// Update GrokFile
func (s *grokfiles) Update(ctx context.Context, id string, grokFile *shared.GrokFile) (*operations.UpdateGrokFileResponse, error) {
