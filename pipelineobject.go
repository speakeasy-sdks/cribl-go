...
func newPipelineObject(sdkConfig sdkConfiguration) *pipelineObject {
...
func (s *pipelineObject) Get(ctx context.Context) (*operations.GetPipelineObjectResponse, error) {
	...
	res := &operations.GetPipelineObjectResponse{
