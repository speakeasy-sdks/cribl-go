...
func newMappingRulesets(sdkConfig sdkConfiguration) *mappingRulesets {
	return &mappingRulesets{
...
func (s *mappingRulesets) Get(ctx context.Context) (*operations.GetMappingRulesetsResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	...
	res := &operations.GetMappingRulesetsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
