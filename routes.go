...
func (s *routes) Get(ctx context.Context, id string) (*operations.GetRouteListIDResponse, error) {
...
func (s *routes) Update(ctx context.Context, id string, routes *shared.Routes) (*operations.UpdateRouteObjectResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "Routes", "json")
	if err != nil {
