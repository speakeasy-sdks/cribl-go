...
func newMappingRuleset(sdkConfig sdkConfiguration) *mappingRuleset {
...
func (s *mappingRuleset) Create(ctx context.Context, request shared.MappingRuleset) (*operations.CreateMappingRulesetResponse, error) {
