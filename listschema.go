...
func newListSchema(sdkConfig sdkConfiguration) *listSchema {
	return &listSchema{
...
func (s *listSchema) Get(ctx context.Context) (*operations.GetListSchemaResponse, error) {
	...
	res := &operations.GetListSchemaResponse{
