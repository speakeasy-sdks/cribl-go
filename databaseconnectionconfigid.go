...
type databaseConnectionConfigID struct {
	sdkConfiguration sdkConfiguration
}

func newDatabaseConnectionConfigID(sdkConfig sdkConfiguration) *databaseConnectionConfigID {
	return &databaseConnectionConfigID{
