...
func newParserObject(sdkConfig sdkConfiguration) *parserObject {
	return &parserObject{
...
// Post - Create Parser
// Create Parser
func (s *parserObject) Post(ctx context.Context, request map[string]interface{}) (*operations.PostParserObjectResponse, error) {
