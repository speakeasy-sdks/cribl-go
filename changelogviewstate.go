...
func newChangelogViewState(sdkConfig sdkConfiguration) *changelogViewState {
	return &changelogViewState{
...
func (s *changelogViewState) Update(ctx context.Context) (*operations.UpdateChangelogViewStateResponse, error) {
