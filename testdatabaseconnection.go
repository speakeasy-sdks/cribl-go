...
func newTestDatabaseConnection(sdkConfig sdkConfiguration) *testDatabaseConnection {
...
func (s *testDatabaseConnection) Post(ctx context.Context, request shared.DatabaseConnectionTest) (*operations.PostTestDatabaseConnectionResponse, error) {
	...
	res := &operations.PostTestDatabaseConnectionResponse{
