...
func newListParser(sdkConfig sdkConfiguration) *listParser {
	return &listParser{
...
func (s *listParser) Get(ctx context.Context) (*operations.GetListParserResponse, error) {
	...
	res := &operations.GetListParserResponse{
