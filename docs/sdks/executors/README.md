...
* [ListExecutorObject](#listexecutorobject) - Get a list of Executor objects
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Executors.ListExecutorObject(ctx)
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.ListExecutorObjectResponse](../../models/operations/listexecutorobjectresponse.md), error**
