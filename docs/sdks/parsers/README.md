...
* [ListParser](#listparser) - Get a list of Parser objects
...
**[*operations.ListParserResponse](../../models/operations/listparserresponse.md), error**
...
**[*operations.PostParserObjectResponse](../../models/operations/postparserobjectresponse.md), error**
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Parsers.Update(ctx, id, requestBody)
    if err != nil {
        log.Fatal(err)
    }
