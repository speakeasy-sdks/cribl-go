...
* [ListObjectFunction](#listobjectfunction) - Get a list of Function objects
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Functions.ListObjectFunction(ctx)
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.ListObjectFunctionResponse](../../models/operations/listobjectfunctionresponse.md), error**
