...
* [ListCollectorObject](#listcollectorobject) - Get a list of Collector objects
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Collectors.ListCollectorObject(ctx)
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.ListCollectorObjectResponse](../../models/operations/listcollectorobjectresponse.md), error**
