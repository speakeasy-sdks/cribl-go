...
* [ListSchema](#listschema) - Get a list of Schema objects
...
**[*operations.ListSchemaResponse](../../models/operations/listschemaresponse.md), error**
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Parquetschemas.Update(ctx, id, requestBody)
    if err != nil {
        log.Fatal(err)
    }
