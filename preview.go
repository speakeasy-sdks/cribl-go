...
func (s *preview) CaptureLiveData(ctx context.Context, request shared.CaptureParams) (*operations.PostLiveDataResponse, error) {
...
func (s *preview) SendEvents(ctx context.Context, request shared.PreviewDataParams) (*operations.PostSampleEventsResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
