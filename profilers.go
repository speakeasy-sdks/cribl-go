...
func newProfilers(sdkConfig sdkConfiguration) *profilers {
	return &profilers{
...
func (s *profilers) Get(ctx context.Context) (*operations.GetProfilersResponse, error) {
	...
	res := &operations.GetProfilersResponse{
