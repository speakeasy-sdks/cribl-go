...
type searchJobMetrics struct {
	sdkConfiguration sdkConfiguration
}

func newSearchJobMetrics(sdkConfig sdkConfiguration) *searchJobMetrics {
	return &searchJobMetrics{
...
func (s *searchJobMetrics) Get(ctx context.Context, request operations.GethSearchJobMetricsRequest) (*operations.GethSearchJobMetricsResponse, error) {
	...
	res := &operations.GethSearchJobMetricsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			out := string(rawBody)
			res.GethSearchJobMetrics200ApplicationJSONString = &out
		default:
