...
func newLiveData(sdkConfig sdkConfiguration) *liveData {
	return &liveData{
...
func (s *liveData) Post(ctx context.Context, request shared.CaptureParams) (*operations.PostLiveDataResponse, error) {
