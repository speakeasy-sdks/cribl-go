...
type sampleEvents struct {
	sdkConfiguration sdkConfiguration
}

func newSampleEvents(sdkConfig sdkConfiguration) *sampleEvents {
	return &sampleEvents{
...
func (s *sampleEvents) Post(ctx context.Context, request shared.PreviewDataParams) (*operations.PostSampleEventsResponse, error) {
