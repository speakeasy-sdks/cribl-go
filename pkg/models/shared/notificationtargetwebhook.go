...
func (o *NotificationTargetWebhookExtraHTTPHeaders) GetName() *string {
	if o == nil {
		return nil
	}
	return o.Name
...
func (o *NotificationTargetWebhookExtraHTTPHeaders) GetValue() string {
	if o == nil {
		return ""
	}
	return o.Value
...
func (o *NotificationTargetWebhook) GetAuthType() *NotificationTargetWebhookAuthenticationType {
	if o == nil {
		return nil
	}
	return o.AuthType
...
func (o *NotificationTargetWebhook) GetCompress() *bool {
	if o == nil {
		return nil
	}
	return o.Compress
...
func (o *NotificationTargetWebhook) GetConcurrency() *int64 {
	if o == nil {
		return nil
	}
...
func (o *NotificationTargetWebhook) GetExtraHTTPHeaders() []NotificationTargetWebhookExtraHTTPHeaders {
	if o == nil {
		return nil
	}
...
func (o *NotificationTargetWebhook) GetFailedRequestLoggingMode() *NotificationTargetWebhookFailedRequestLoggingMode {
	if o == nil {
		return nil
	}
...
func (o *NotificationTargetWebhook) GetFlushPeriodSec() *int64 {
	if o == nil {
		return nil
	}
...
func (o *NotificationTargetWebhook) GetFormat() *NotificationTargetWebhookFormat {
	if o == nil {
		return nil
	}
	return o.Format
...
func (o *NotificationTargetWebhook) GetID() string {
	if o == nil {
		return ""
	}
	return o.ID
...
func (o *NotificationTargetWebhook) GetKeepAlive() *bool {
	if o == nil {
		return nil
	}
	return o.KeepAlive
...
func (o *NotificationTargetWebhook) GetMaxPayloadEvents() *int64 {
	if o == nil {
		return nil
	}
...
func (o *NotificationTargetWebhook) GetMaxPayloadSizeKB() *int64 {
	if o == nil {
		return nil
	}
...
func (o *NotificationTargetWebhook) GetMethod() *NotificationTargetWebhookMethod {
	if o == nil {
		return nil
	}
	return o.Method
...
func (o *NotificationTargetWebhook) GetRejectUnauthorized() *bool {
	if o == nil {
		return nil
	}
...
func (o *NotificationTargetWebhook) GetSafeHeaders() []string {
	if o == nil {
		return nil
	}
...
func (o *NotificationTargetWebhook) GetSystemFields() []string {
	if o == nil {
		return nil
	}
...
func (o *NotificationTargetWebhook) GetTimeoutSec() *int64 {
	if o == nil {
		return nil
	}
	return o.TimeoutSec
...
func (o *NotificationTargetWebhook) GetType() NotificationTargetWebhookType {
	if o == nil {
		return NotificationTargetWebhookType("")
	}
	return o.Type
}

func (o *NotificationTargetWebhook) GetURL() string {
	if o == nil {
		return ""
	}
	return o.URL
...
func (o *NotificationTargetWebhook) GetUseRoundRobinDNS() *bool {
	if o == nil {
		return nil
	}
