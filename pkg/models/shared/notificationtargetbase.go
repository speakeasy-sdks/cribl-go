...
func (o *NotificationTargetBase) GetID() string {
	if o == nil {
		return ""
	}
	return o.ID
...
func (o *NotificationTargetBase) GetSystemFields() []string {
	if o == nil {
		return nil
	}
...
func (o *NotificationTargetBase) GetType() NotificationTargetBaseOutputType {
	if o == nil {
		return NotificationTargetBaseOutputType("")
	}
	return o.Type
}
