...
func newAppscopeLibEntry(sdkConfig sdkConfiguration) *appscopeLibEntry {
	return &appscopeLibEntry{
...
func (s *appscopeLibEntry) Create(ctx context.Context, request shared.AppscopeLibEntry) (*operations.CreateAppscopeLibEntryResponse, error) {
