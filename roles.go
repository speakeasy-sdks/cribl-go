...
// Create - Create Role
// Create Role
func (s *roles) Create(ctx context.Context, request shared.Role) (*operations.CreateRoleResponse, error) {
...
// Delete - Delete Role
// Delete Role
func (s *roles) Delete(ctx context.Context, id string) (*operations.DeleteRoleResponse, error) {
...
// Get - Get Role by ID
// Get Role by ID
func (s *roles) Get(ctx context.Context, id string) (*operations.GetRoleResponse, error) {
...
// Update - Update Role
// Update Role
func (s *roles) Update(ctx context.Context, id string, role *shared.Role) (*operations.UpdateRoleResponse, error) {
