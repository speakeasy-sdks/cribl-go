...
func (s *git) CountFiles(ctx context.Context, group *string) (*operations.GetCountFileResponse, error) {
...
func (s *git) Create(ctx context.Context, request shared.GitCommitParams) (*operations.CreateCommitResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
...
func (s *git) Get(ctx context.Context) (*operations.GetVersioningResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
...
func (s *git) GetLogandTextualDiff(ctx context.Context, commit *string, group *string) (*operations.GetLogandTextualDiffResponse, error) {
...
func (s *git) GetTextualDiff(ctx context.Context, commit *string, group *string) (*operations.GetTextualDiffResponse, error) {
...
func (s *git) GetWorkingTree(ctx context.Context, group *string) (*operations.GetWorkingTreeResponse, error) {
...
func (s *git) ListChangedFiles(ctx context.Context, id *string, group *string) (*operations.ListChangedFilesResponse, error) {
...
func (s *git) Push(ctx context.Context) (*operations.PushCurrentConfigResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
...
func (s *git) Sync(ctx context.Context) (*operations.SyncRemoteRepoResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
...
// Update git settings
func (s *git) Update(ctx context.Context) (*operations.UpdateGitSettingsResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url := strings.TrimSuffix(baseURL, "/") + "/system/settings/git-settings"
