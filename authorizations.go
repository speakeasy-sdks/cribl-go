...
func newAuthorizations(sdkConfig sdkConfiguration) *authorizations {
...
func (s *authorizations) Get(ctx context.Context) (*operations.GetAuthorizationsResponse, error) {
