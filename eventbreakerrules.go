...
func (s *eventBreakerRules) Delete(ctx context.Context, id string) (*operations.DeleteEventBreakerResponse, error) {
...
func (s *eventBreakerRules) Get(ctx context.Context, id string) (*operations.GetEventBreakerIDResponse, error) {
...
func (s *eventBreakerRules) Post(ctx context.Context, request shared.EventBreakerRuleset) (*operations.PostEventBreakerResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url := strings.TrimSuffix(baseURL, "/") + "/lib/breakers"
...
func (s *eventBreakerRules) Update(ctx context.Context, id string, eventBreakerRuleset *shared.EventBreakerRuleset) (*operations.UpdateEventBreakerResponse, error) {
