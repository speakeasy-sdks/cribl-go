...
func (s *features) Get(ctx context.Context, id string) (*operations.GetFeatureResponse, error) {
...
// List all features
func (s *features) ListFeatures(ctx context.Context) (*operations.ListFeaturesResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url := strings.TrimSuffix(baseURL, "/") + "/settings/features"
