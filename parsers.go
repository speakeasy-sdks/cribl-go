...
// Delete Parser
func (s *parsers) Delete(ctx context.Context, id string) (*operations.DeleteParserIDResponse, error) {
...
// Get Parser by ID
func (s *parsers) Get(ctx context.Context, id string) (*operations.GetParserIDResponse, error) {
...
// Post - Create Parser
// Create Parser
func (s *parsers) Post(ctx context.Context, request map[string]interface{}) (*operations.PostParserObjectResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url := strings.TrimSuffix(baseURL, "/") + "/lib/parsers"
...
// Update Parser
func (s *parsers) Update(ctx context.Context, id string, requestBody map[string]interface{}) (*operations.UpdateParserIDResponse, error) {
