...
func newSearchJob(sdkConfig sdkConfiguration) *searchJob {
	return &searchJob{
...
// Create SearchJob
func (s *searchJob) Create(ctx context.Context, request shared.SearchJob) (*operations.CreateSearchJobResponse, error) {
