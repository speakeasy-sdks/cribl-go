...
func newLogFiles(sdkConfig sdkConfiguration) *logFiles {
	return &logFiles{
...
func (s *logFiles) Get(ctx context.Context) (*operations.GetLogFilesResponse, error) {
	...
	res := &operations.GetLogFilesResponse{
