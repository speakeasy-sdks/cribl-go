...
func newBulletinMessage(sdkConfig sdkConfiguration) *bulletinMessage {
...
func (s *bulletinMessage) Create(ctx context.Context, request shared.BulletinMessage) (*operations.CreateBulletinMessageResponse, error) {
