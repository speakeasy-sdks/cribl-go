...
type regexLibEntryObject struct {
	sdkConfiguration sdkConfiguration
}

func newRegexLibEntryObject(sdkConfig sdkConfiguration) *regexLibEntryObject {
	return &regexLibEntryObject{
...
func (s *regexLibEntryObject) Get(ctx context.Context) (*operations.GetRegexLibEntryObjectResponse, error) {
	...
	res := &operations.GetRegexLibEntryObjectResponse{
