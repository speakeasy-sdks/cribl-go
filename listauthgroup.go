...
type listAuthGroup struct {
	sdkConfiguration sdkConfiguration
}

func newListAuthGroup(sdkConfig sdkConfiguration) *listAuthGroup {
...
func (s *listAuthGroup) Get(ctx context.Context) (*operations.GetListAuthGroupResponse, error) {
	...
	res := &operations.GetListAuthGroupResponse{
