...
func newPolicyRules(sdkConfig sdkConfiguration) *policyRules {
	return &policyRules{
...
func (s *policyRules) Get(ctx context.Context) (*operations.GetPolicyRulesResponse, error) {
	...
	res := &operations.GetPolicyRulesResponse{
