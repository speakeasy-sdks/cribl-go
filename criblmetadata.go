...
func newCriblMetadata(sdkConfig sdkConfiguration) *criblMetadata {
	return &criblMetadata{
		sdkConfiguration: sdkConfig,
	}
}

// Get - Obtain metadata which Cribl Stream/Edge uses when acting as a Service Provider
func (s *criblMetadata) Get(ctx context.Context) (*operations.GetCriblMetadataResponse, error) {
