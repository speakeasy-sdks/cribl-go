...
type existingDiagBundles struct {
	sdkConfiguration sdkConfiguration
}

func newExistingDiagBundles(sdkConfig sdkConfiguration) *existingDiagBundles {
	return &existingDiagBundles{
...
func (s *existingDiagBundles) Get(ctx context.Context) (*operations.GetExistingDiagBundlesResponse, error) {
	...
	res := &operations.GetExistingDiagBundlesResponse{
