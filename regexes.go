...
func (s *regexes) Delete(ctx context.Context, id string) (*operations.DeleteRegexLibEntryResponse, error) {
...
func (s *regexes) Get(ctx context.Context, id string) (*operations.GetRegexLibEntryIDResponse, error) {
...
func (s *regexes) Post(ctx context.Context, request shared.RegexLibEntry) (*operations.PostRegexLibEntryResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url := strings.TrimSuffix(baseURL, "/") + "/lib/regex"
...
func (s *regexes) Update(ctx context.Context, id string, regexLibEntry *shared.RegexLibEntry) (*operations.UpdateRegexLibEntryResponse, error) {
